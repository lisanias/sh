...
$dataini2 = strtotime($_SESSION['dataini']);
$dataini2 = $dataini2 + 86400;
$datasql = date('Y-m-d', $dataini2);
...
$sql = "SELECT 
		...
		WHERE matricula.id_evento = {$_SESSION['evento']} and pagamento.data_pg = '{$datasql}'
...
<div class="widget widget-table action-table">
    ...
    <div class="widget-header">
        ...
        <h3>Resumos - Dia: (<?php echo date('d/m/Y', $dataini2) ?>)</h3>
    </div> <!-- /widget-header -->
