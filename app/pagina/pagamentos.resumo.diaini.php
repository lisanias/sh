...
$dataini2 = strtotime($_SESSION['dataini']) + 345600;
...
$sql = "SELECT 
		...
		WHERE matricula.id_evento = {$_SESSION['evento']} and pagamento.data_pg = '{$_SESSION['dataini']}'
...
<div class="widget widget-table action-table">
    ...
    <div class="widget-header">
        ...
        <h3>Resumos - Dia de Início (<?php echo date('d/m/Y', strtotime($_SESSION['dataini'])) ?>)</h3>
    </div> <!-- /widget-header -->
