...
$sql_pag_cartao = [
            ...
            "merchantOrderId"=>$requisicao->getMerchantOrderId(),
            "requisitionNSU"=>$requisicao->getPayment()->getProofOfSale(),
            "captureNSU"=>$captura->getProofOfSale(),
            "type"=>$requisicao->getPayment()->getType(),
